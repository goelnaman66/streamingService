      ...
      {props => {
        ...
        return (
          <div className="app">
            ...
            <Form style={{ Width: '400px',backgroundColor:'rgba(255,255,255,0.8)',padding:'3rem ',borderRadius:'1.2rem' }} {...formItemLayout} onSubmit={handleSubmit} >
            <h2 >Sign Up</h2>
              ...
              <Form.Item {...tailFormItemLayout}>
                <Button onClick={handleSubmit} type="primary" disabled={isSubmitting} style={{backgroundColor:'rgba(0,0,0,1)',border:'none' }}>
                  Submit
                </Button>
              </Form.Item>
            </Form>
